            ...
            for w_type in ['warmup_cosine', 'warmup_linear']:
                for w_factor in [0.1, 0.3]:
                    for w_iter in [500, 1000]:
                        ...
                        rc = call(f"/scratch/akshay.goindani/hateful_memes-hate_detectron/hyperparameter_sweep/sweep.sh {str(i)} {lr} {w_steps} {w_type} {w_factor} {w_iter} {bs} {feats_dir} {train_dir}", shell=True)
                        i+=1
